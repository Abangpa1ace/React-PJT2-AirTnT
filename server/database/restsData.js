...
const TITLECATEGORIES = [
  ...
  },
  {
    ...
    title: "[Sol's Cozy Home] 강남역 2분거리/빔프로젝터/영화관/레트로 감성/낭만적인야경",
  },
  {
    category: {
      city: "강남",
  ...
  },
  {
    ...
    title: "서울 송파 잠실 자가격리 가능한 복층 숙소 빌려드립니다.",
  },
  {
    category: {
      city: "송파",
    ...
    title: "<잠실.올림픽공원>신축! 깨끗하고 아늑한 J&J Villa",
  },
  {
    category: {
      city: "송파",
  ...
  },
  {
    ...
    title: "【Clean】Safe, 잠실, Lotte World, Jamsil, Grate View!!",
  },
]

const SUBINFOS = ['무선 인터넷', '헤어드라이어', 'TV', 'Wi-fi', '컴퓨터', '식기', '취사도구', '무료 주차', '에어컨', '난방', '온돌', '화재경보기', '냉장고', '전자레인지', '정원', '반려견 동반가능']

// Making Data(150)
for (let i=1 ; i <= 150 ; i++) {
  const rdmTitCat = randomer(TITLECATEGORIES);
  restsData.push({
    id: i,
    imageList: [
      randomer(IMAGES),
    ...
    category: rdmTitCat.category,
    title: rdmTitCat.title,
    mainInfo: {
      maxGuest: randomer(6),
      bedroom: randomer(3),
      bed: randomer(6),
    ...
    location: {
      ...
      long: 126.64 + Number((Math.random() * 0.26).toFixed(3)),
    },
    superHost: false,
  })
}
